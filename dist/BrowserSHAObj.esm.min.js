 ...
 * @author UmamiAppearance [mail@umamiappearance.eu]
 * @license GPL-3.0
 */const v=["SHA-1","SHA-256","SHA-384","SHA-512"];class A{#e=null;#s=null;#i=null;#n=[];constructor(t="SHA-256"){const e=this.constructor.algorithmsAvailable();if(this.#s=0|[].concat(String(t).match(/[0-9]+/)).at(0),this.#e=`SHA-${this.#s}`,1===this.#s&&(this.#s=160),!e.has(this.#e))throw new TypeError(`Available algorithms are: '${v.join(", ")}'.`);this.baseEx=new m,this.#r()}static algorithmsAvailable(){return new Set(v)}static algorithmsGuaranteed(){return this.constructor.algorithmsAvailable()}static async new(t="SHA-256",e=null){const s=new this(t);return null!==e&&await s.update(e),s}get digestSize(){return this.#s/8}get blockSize(){return this.#s>256?128:64}get name(){return this.#e}async copy(){const t=this.#n.length?Uint8Array.from(this.#n):null;return this.constructor.new(this.#e,t)}async update(t,e=!1){let s;(t=t instanceof ArrayBuffer?new Uint8Array(t):ArrayBuffer.isView(t)?new Uint8Array(t.buffer):this.baseEx.byteConverter.encode(t,"uint8")).byteLength<2e8?(this.#n=e?Array.from(t):this.#n.concat(Array.from(t)),s=Uint8Array.from(this.#n),s.byteLength>5e8&&!this.warned&&(console.warn("The stored input is getting really big. Dependent from your environment this can lead to memory issues."),this.warned=!0)):(console.warn("Input gets too big to safely store it in memory. It will get processed directly and neither stored nor concatenated to previous input. If the operation fails, it is due to memory issues."),s=t),this.#i=await window.crypto.subtle.digest(this.#e,s)}async replace(t){await this.update(t,!0)}digest(){return this.#i}#r(){const t=(t,e)=>t.splice(t.indexOf(e),1),e=t=>t.charAt(0).toUpperCase().concat(t.slice(1));this.hexdigest=()=>this.#i?this.baseEx.base16.encode(this.#i):null;const s=Object.keys(this.baseEx);this.basedigest={toSimpleBase:{}},t(s,"base1"),t(s,"byteConverter"),t(s,"simpleBase");for(const t of s)this.basedigest[`to${e(t)}`]=(...e)=>this.#i?this.baseEx[t].encode(this.#i,...e):null;for(const t in this.baseEx.simpleBase)this.basedigest.toSimpleBase[e(t)]=(...e)=>this.#i?this.baseEx.simpleBase[t].encode(this.#i,...e):null;this.basedigest.toBytes=(...t)=>this.#i?this.baseEx.byteConverter.encode(this.#i,...t):null}}export{A as default};
