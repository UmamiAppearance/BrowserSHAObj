 ...
 * @author UmamiAppearance [mail@umamiappearance.eu]
 * @license GPL-3.0
 */class u extends l{constructor(...t){super(),this.converter=new o(16,1,2),this.charsets.default="0123456789abcdef",this.hasSignedMode=!0,this.isMutable.signed=!0,this.isMutable.upper=!0,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,null,...e)}decode(t,...e){return super.decode(t,(t=>{let{input:e}=t;return e=e.replace(/^0x/,""),e.length%2&&(e="0".concat(e)),e}),null,...e)}}
/**
