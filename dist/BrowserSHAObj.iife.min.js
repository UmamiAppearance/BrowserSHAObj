...
/*
     ...
     * @license GPL-3.0
     */
class m{constructor(t="SHA-256",e=null){const s=this.constructor.getAlgorithms();if(t=`SHA-${String(t).match(/[0-9]+/)[0]}`,!s.includes(t))throw new Error(`Invalid algorithm.\nValid arguments are: "${s.join(", ")}".`);return this.algorithm=t,this.hash={},this.hash.array=null,this.hash.update=this.makeHashArray.bind(this),null!==e&&this.makeHashArray(e),this.hash}static getAlgorithms(){return["SHA-1","SHA-256","SHA-384","SHA-512"]}async makeHashArray(t){t=this.testInput(t);const e=await window.crypto.subtle.digest(this.algorithm,t);return this.hash.array=new Uint8Array(e),this.addConverters(),!0}async addConverters(){if(this.hash.hasConverters)return;const t=(t,e)=>t.splice(t.indexOf(e),1);this.hash.toHex=()=>this.baseEx.base16.encode(this.hash.array);const e=Object.keys(this.baseEx);t(e,"base1"),t(e,"base16"),t(e,"simpleBase");for(const t of e)this.hash[`to${s=t,s.charAt(0).toUpperCase().concat(s.slice(1))}`]=()=>this.baseEx[t].encode(this.hash.array);var s;this.hash.hasConverters=!0}testInput(t){if("string"==typeof t)t=(new TextEncoder).encode(t);else if(!(t instanceof ArrayBuffer||ArrayBuffer.isView(t)))throw new TypeError("Input must be of type String, ArrayBuffer or ArrayBufferView (typed array)");return t}}return m.prototype.baseEx=new class{constructor(t="buffer"){if(!r.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(r.typeList.join(", ")),new TypeError(e)}this.base1=new h("default",t),this.base16=new u("default",t),this.base32_crockford=new c("rfc4648",t),this.base32_rfc3548=new c("rfc3548",t),this.base32_rfc4648=new c("rfc4648",t),this.base32_zbase32=new c("zbase32",t),this.base58=new d("default",t),this.base58_bitcoin=new d("bitcoin",t),this.base58_flickr=new d("flickr",t),this.base64=new f("default",t),this.base64_urlsafe=new f("urlsafe",t),this.base85adobe=new p("adobe",t),this.base85ascii=new p("ascii85",t),this.base85_z85=new p("z85",t),this.base91=new g("default",t),this.leb128=new b("default",t),this.byteConverter=new y(t),this.simpleBase={};for(let e=2;e<37;e++)this.simpleBase[`base${e}`]=new w(e,t)}}("bytes"),m}();
