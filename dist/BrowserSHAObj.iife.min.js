...
/*
     ...
     * @license GPL-3.0
     */
const m=new class{constructor(t="buffer"){if(!r.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(r.typeList.join(", ")),new TypeError(e)}this.base1=new h("default",t),this.base16=new u("default",t),this.base32_crockford=new c("rfc4648",t),this.base32_rfc3548=new c("rfc3548",t),this.base32_rfc4648=new c("rfc4648",t),this.base32_zbase32=new c("zbase32",t),this.base58=new d("default",t),this.base58_bitcoin=new d("bitcoin",t),this.base58_flickr=new d("flickr",t),this.base64=new p("default",t),this.base64_urlsafe=new p("urlsafe",t),this.base85adobe=new f("adobe",t),this.base85ascii=new f("ascii85",t),this.base85_z85=new f("z85",t),this.base91=new g("default",t),this.leb128=new y("default",t),this.byteConverter=new b(t),this.simpleBase={};for(let e=2;e<37;e++)this.simpleBase[`base${e}`]=new w(e,t)}};class v{#e=null;#s=null;#i=[];constructor(t="SHA-256"){const e=this.constructor.algorithmsAvailable();if(this.#s=0|String(t).match(/[0-9]+/)[0],this.blockSize=this.#s>256?128:64,this.#e=`SHA-${this.#s}`,this.#s=Math.min(160,this.#s),!e.has(this.#e))throw new TypeError(`Available algorithms are: '${Array.from(e).join(", ")}'.`);this.digest=null,this.#n()}static algorithmsAvailable(){return new Set(["SHA-1","SHA-256","SHA-384","SHA-512"])}static algorithmsGuaranteed(){return this.constructor.algorithmsAvailable()}static async new(t="SHA-256",e=null){const s=new v(t);return null!==e&&await s.update(e),s}get digestSize(){return this.#s/8}get name(){return this.#e}async update(t,e=!1){t=m.byteConverter.encode(t),e?this.#i=Array.from(t):this.#i.push(...t),this.digest=await window.crypto.subtle.digest(this.#e,Uint8Array.from(this.#i))}async replace(t){this.update(t,!0)}#n(){const t=(t,e)=>t.splice(t.indexOf(e),1),e=t=>t.charAt(0).toUpperCase().concat(t.slice(1));this.hexdigest=()=>this.digest?m.base16.encode(this.digest):null;const s=Object.keys(m);this.basedigest={toSimpleBase:{}},t(s,"base1"),t(s,"byteConverter"),t(s,"simpleBase");for(const t of s)this.basedigest[`to${e(t)}`]=()=>this.digest?m[t].encode(this.digest):null;for(const t in m.simpleBase)this.basedigest.toSimpleBase[e(t)]=()=>this.digest?m.simpleBase[t].encode(this.digest):null;this.basedigest.toBytes=()=>this.digest?m.byteConverter.encode(this.digest):null}}return v}();
