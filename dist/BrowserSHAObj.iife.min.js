...
/*
     ...
     * @author UmamiAppearance [mail@umamiappearance.eu]
     * @license GPL-3.0
     */if(!m)throw new Error("BaseEx needs to be accessible.");const v=new m;class A{#e=null;#s=null;#i=[];constructor(t="SHA-256"){const e=this.constructor.algorithmsAvailable();if(this.#s=0|String(t).match(/[0-9]+/)[0],this.blockSize=this.#s>256?128:64,this.#e=`SHA-${this.#s}`,1===this.#s&&(this.#s=160),!e.has(this.#e))throw new TypeError(`Available algorithms are: '${Array.from(e).join(", ")}'.`);this.digest=null,this.#n()}static algorithmsAvailable(){return new Set(["SHA-1","SHA-256","SHA-384","SHA-512"])}static algorithmsGuaranteed(){return this.constructor.algorithmsAvailable()}static async new(t="SHA-256",e=null){const s=new A(t);return null!==e&&await s.update(e),s}get digestSize(){return this.#s/8}get name(){return this.#e}async update(t,e=!1){return t=v.byteConverter.encode(t),e?this.#i=Array.from(t):this.#i.push(...t),this.digest=await window.crypto.subtle.digest(this.#e,Uint8Array.from(this.#i)),!0}async replace(t){return this.update(t,!0)}#n(){const t=(t,e)=>t.splice(t.indexOf(e),1),e=t=>t.charAt(0).toUpperCase().concat(t.slice(1));this.hexdigest=()=>v.base16.encode(this.digest);const s=Object.keys(v);this.basedigest={toSimpleBase:{}},t(s,"base1"),t(s,"byteConverter"),t(s,"simpleBase");for(const t of s)this.basedigest[`to${e(t)}`]=()=>this.digest?v[t].encode(this.digest):null;for(const t in v.simpleBase)this.basedigest.toSimpleBase[e(t)]=()=>this.digest?v.simpleBase[t].encode(this.digest):null;this.basedigest.toBytes=()=>this.digest?v.byteConverter.encode(this.digest):null}}return A}();
